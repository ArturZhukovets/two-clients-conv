...
export declare class TrieBlobInternals implements BitMaskInfo {
    ...
    constructor(nodes: Uint32Array, charIndex: Readonly<CharIndex>, maskInfo: BitMaskInfo);
}
...
export declare class TrieBlobIRoot extends TrieBlobINode implements ITrieNodeRoot {
    ...
    constructor(trie: TrieBlobInternals, nodeIdx: number, info: Readonly<TrieInfo>, methods: ITrieSupportMethods | undefined);
