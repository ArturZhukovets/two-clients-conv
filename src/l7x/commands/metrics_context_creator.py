...
from l7x.utils.cmd_manager_utils import CmdGlobalContextCreatorReturn, CmdManager, CmdMiddlewareResults
...
MetricCmdManager = CmdManager[BaseCmdGlobalContext, BaseCmdLocalContext]
